...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { Bank_Details: @user_info.Bank_Details, location: @user_info.location, name: @user_info.name, phone: @user_info.phone, preferted_genre: @user_info.preferted_genre }
    end
  ...
  test "should update user_info" do
    put :update, id: @user_info, user_info: { Bank_Details: @user_info.Bank_Details, location: @user_info.location, name: @user_info.name, phone: @user_info.phone, preferted_genre: @user_info.preferted_genre }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
